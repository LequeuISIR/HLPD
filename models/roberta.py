# taken from https://github.com/facebookresearch/mexma/blob/761079ac0e084ffcbc34472441bc9134311d0dfd/backbone/block_diagonal_roberta.py
...
class EfficientXLMRobertaModel(XLMRobertaPreTrainedModel):
    ...
    def forward(
        ...
        if not dont_return_padded_input:
            ...
            ), "The padded output should have the original shape of the input, but got {} and {}".format(
                encoder_outputs.last_hidden_state.shape, embedding_output.shape
            )
